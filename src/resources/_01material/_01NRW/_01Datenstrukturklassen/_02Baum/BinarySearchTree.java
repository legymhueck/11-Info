package resources._01material._01NRW._01Datenstrukturklassen._02Baum;
 ...
 * </p>
 * <p>
 * Generische Klasse GraphicsBinaryTree<ContentType>
 * </p>
 * <p>
 * Mithilfe der generischen Klasse GraphicsBinaryTree koennen beliebig viele
 ...
 * die ebenfalls Objekte der Klasse GraphicsBinaryTree sind.<br />
...
public class BinarySearchTree<ContentType extends ComparableContent<ContentType>> {
     ...
     * der vorgegebenen Ordnungsrelation in den GraphicsBinaryTree eingeordnet.
     *
     ...
     *
     * @return den linken Teilbaum (Objekt vom Typ GraphicsBinaryTree<ContentType>)
     ...
     * Wenn er leer ist, wird null zurueckgegeben.
     *
     * @return den rechten Teilbaum (Objekt vom Typ GraphicsBinaryTree<ContentType>)
